( () => {
    var e = {
        272: () => {
            const e = document.querySelector(".page")
              , t = document.querySelector(".menu-main")
              , s = document.querySelector(".page__overlay")
              , i = document.querySelectorAll(".circular-button--chat")
              , r = document.querySelectorAll(".circular-button--call")
              , n = document.querySelector("#modal-feedback").content
              , a = document.querySelector("#modal-callback").content
              , l = n.querySelector(".modal-feedback")
              , o = n.querySelector(".modal__circular-button--close");
            i.forEach((i => {
                i.addEventListener("click", (function() {
                    e.append(l),
                    s.classList.add("page__overlay--visible"),
                    t.classList.remove("menu-main--is-open"),
                    e.classList.add("page--scroll-stop")
                }
                ))
            }
            )),
            o.addEventListener("click", (function() {
                l.remove(),
                s.classList.remove("page__overlay--visible"),
                e.classList.remove("page--scroll-stop")
            }
            ));
            const d = a.querySelector(".modal-callback")
              , c = a.querySelector(".modal__circular-button--close");
            r.forEach((i => {
                i.addEventListener("click", (function() {
                    e.append(d),
                    s.classList.add("page__overlay--visible"),
        ...
        825: (e, t, s) => {
            "use strict";
            e.exports = s.p + "svg/brand-logo-hewlett-packard-fc643abb1e2122a9a17d.svg"
        }
        ,
        141: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-acer-7d6c6158dfdcf571c161.png"
        }
        ,
        490: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-apple-bbf696f13cc45f8c12da.png"
        }
        ,
        667: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-bosch-18ea97a204e7cad4d34b.png"
        }
        ,
        205: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-lenovo-af22b86b7a68afc776fe.png"
        }
        ,
        386: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-samsung-5dfd1c9fb75d776e2c0a.png"
        }
        ,
        589: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-sony-a02f734d272f8cfa927e.png"
        }
        ,
        307: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/brand-logo-viewsonic-00afe8a253e7122591b2.png"
        }
        ,
        868: (e, t, s) => {
            "use strict";
            e.exports = s.p + "images/hero-image-91b4e704b4c261679a1e.jpg"
        }
    }
      , t = {};
    function s(i) {
    ...
    ( () => {
        ...
        t()(p);
        const u = {
            mediaMinWidthSM: window.matchMedia("(min-width: 576px)"),
            mediaMinWidthMD: window.matchMedia("(min-width: 768px)"),
            mediaMinWidthLG: window.matchMedia("(min-width: 1120px)"),
            mediaMinWidthXL: window.matchMedia("(min-width: 1366px)")
        }
          , m = document.querySelector(".page")
          , h = document.querySelector(".menu-main")
          , f = document.querySelector(".page__overlay")
          , g = document.querySelector(".circular-button--burger")
          , v = document.querySelector(".menu-main__circular-button--close");
        g.addEventListener("click", (function() {
            m.classList.add("page--scroll-stop"),
            h.classList.add("menu-main--is-open"),
            f.classList.add("page__overlay--visible")
        }
        )),
        v.addEventListener("click", (function() {
            m.classList.remove("page--scroll-stop"),
            h.classList.remove("menu-main--is-open"),
            f.classList.remove("page__overlay--visible")
        }
        )),
        ...
        for (const e in u)
            Object.hasOwnProperty.call(u, e) && u[e].addEventListener("change", ( () => {
                h.classList.remove("menu-main--is-open"),
                f.classList.remove("page__overlay--visible")
            }
            ));
        const w = document.querySelector(".hero__show-more-button")
          , b = document.querySelector(".hero__text");
        let y = b.clientHeight;
        w.addEventListener("click", ( () => {
            b.clientHeight < b.scrollHeight ? (b.style.cssText = `\n      height: ${b.scrollHeight}px;\n    `,
            w.classList.add("hero__show-more-button--expanded")) : (b.style.cssText = `\n    height: ${y}px;\n    `,
            w.classList.remove("hero__show-more-button--expanded"))
        }
        ));
        for (const e in u)
            Object.hasOwnProperty.call(u, e) && u[e].addEventListener("change", ( () => {
        ...
        function T(e, t) {
            ...
            Object.keys(t).forEach((s => {
                void 0 === e[s] ? e[s] = t[s] : S(t[s]) && S(e[s]) && Object.keys(t[s]).length > 0 && T(e[s], t[s])
            }
            ))
        }
        s(272);
            ...
            for (let i = 1; i < arguments.length; i += 1) {
                ...
                !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                    ...
                    for (let t = 0, i = s.length; t < i; t += 1) {
                        ...
                        void 0 !== n && n.enumerable && (_(e[i]) && _(r[i]) ? r[i].__swiper__ ? e[i] = r[i] : k(e[i], r[i]) : !_(e[i]) && _(r[i]) ? (e[i] = {},
                        r[i].__swiper__ ? e[i] = r[i] : k(e[i], r[i])) : e[i] = r[i])
                    }
                }
            }
            var s;
        ...
        function j(e) {
            ...
            H || (H = function(e) {
                ...
                const p = n.match(/(iPod)(.*OS\s([\d_]+))?/)
                  ...
                  , m = "Win32" === r;
                let h = "MacIntel" === r;
                return !c && h && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/),
                c || (c = [0, 1, "13_0_0"]),
                h = !1),
                d && !m && (a.os = "android",
                a.android = !0),
        ...
        var Q = {
            updateSize: function() {
                ...
                0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt($(i, "padding-left") || 0, 10) - parseInt($(i, "padding-right") || 0, 10),
                s = s - parseInt($(i, "padding-top") || 0, 10) - parseInt($(i, "padding-bottom") || 0, 10),
                Number.isNaN(t) && (t = 0),
                Number.isNaN(s) && (s = 0),
                Object.assign(e, {
                    width: t,
            ...
            updateSlides: function() {
                ...
                const s = e.params
                  ...
                  , c = O(r, `.${e.params.slideClass}, swiper-slide`)
                ...
                s.centeredSlides && s.cssMode && (I(i, "--swiper-centered-offset-before", ""),
                I(i, "--swiper-centered-offset-after", ""));
                ...
                for (let i = 0; i < p; i += 1) {
                    ...
                    !c[i] || "none" !== $(r, "display")) {
                        if ("auto" === s.slidesPerView) {
                            ...
                            s.roundLengths)
                                E = e.isHorizontal() ? q(r, "width", !0) : q(r, "height", !0);
                            else {
                                const e = t(n, "width")
                                  , s = t(n, "padding-left")
                                  , i = t(n, "padding-right")
                            ...
                            E = (n - (s.slidesPerView - 1) * b) / s.slidesPerView,
                            s.roundLengths && (E = Math.floor(E)),
                            c[i] && (c[i].style[e.getDirectionLabel("width")] = `${E}px`);
                        c[i] && (c[i].swiperSlideSize = E),
                        h.push(E),
                        s.centeredSlides ? (y = y + E / 2 + S / 2 + b,
                        0 === S && 0 !== i && (y = y - n / 2 - b),
                        0 === i && (y = y - n / 2 - b),
                        Math.abs(y) < .001 && (y = 0),
                ...
                a && l && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize + b}px`),
                ...
                s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                    I(i, "--swiper-centered-offset-before", -u[0] + "px"),
                    I(i, "--swiper-centered-offset-after", e.size / 2 - h[h.length - 1] / 2 + "px");
        ...
        var Z = {
            slideTo: function(e, t, s, i, r) {
                ...
                let a = e;
                a < 0 && (a = 0);
                const {params: l, snapGrid: o, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: m, enabled: h} = n;
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    n = e.getSlideIndex(O(s, `${a}[data-swiper-slide-index="${r}"]`)[0]),
                    M(( () => {
                        e.slideTo(n)
                    }
          ...
          , ee = {
            loopCreate: function(e) {
                ...
                ;
                l ? (s.loopAddBlankSlides ? (d(a - t.slides.length % a),
                t.recalcSlides(),
                t.updateSlides()) : z("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"),
                r()) : o ? (s.loopAddBlankSlides ? (d(s.grid.rows - t.slides.length % s.grid.rows),
                t.recalcSlides(),
                t.updateSlides()) : z("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"),
                r()) : r(),
                t.loopFix({
                    slideRealIndex: e,
            ...
            loopFix: function(e) {
                ...
                d.length < f + v ? z("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : w && "row" === m.grid.fill && z("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                const b = []
                  , y = [];
                let S = o.activeIndex;
                void 0 === n ? n = o.getSlideIndex(d.filter((e => e.classList.contains(m.slideActiveClass)))[0]) : S = n;
                const T = "next" === i || !i
                  , x = "prev" === i || !i;
                let E = 0
                  , L = 0;
                const C = w ? Math.ceil(d.length / m.grid.rows) : d.length
                  , M = (w ? d[n].column : n) + (h && void 0 === r ? -f / 2 + .5 : 0);
                if (M < v) {
                    E = Math.max(v - M, g);
                ...
                o.recalcSlides(),
                "auto" === m.slidesPerView ? o.updateSlides() : w && (b.length > 0 && x || y.length > 0 && T) && o.slides.forEach(( (e, t) => {
                ...
                s)
                    if (b.length > 0 && x) {
                        if (void 0 === t) {
                            ...
                            l ? o.setTranslate(o.translate - t) : (o.slideTo(S + Math.ceil(E), 0, !1, !0),
                        ...
                        if (void 0 === t) {
                            ...
                            l ? o.setTranslate(o.translate - t) : (o.slideTo(S - L, 0, !1, !0),
                            r && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t,
                            o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                        } else {
        ...
        function se(e) {
            ...
            if ("touchstart" === i.type)
                return void te(t, i, i.targetTouches[0].pageX);
            ...
            let o = i.target;
            if ("wrapper" === n.touchEventsTarget && !t.wrapperEl.contains(o))
                return;
            ...
            let f = !0;
            o.matches(r.focusableElements) && (f = !1,
            ...
            !n.touchStartForcePreventDefault && !g || o.isContentEditable || i.preventDefault(),
        ...
        function ie(e) {
            ...
            let h = s.isHorizontal() ? u : m
              , f = s.isHorizontal() ? n.currentX - n.previousX : n.currentY - n.previousY;
            ...
            if ((new Date).getTime(),
            i.isMoved && i.allowThresholdMove && g !== s.touchesDirection && v && w && Math.abs(h) >= 1)
            ...
            h > 0 ? (v && w && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }),
            i.currentTranslate > s.minTranslate() && (b = !1,
            r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + h) ** y))) : h < 0 && (v && w && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                direction: "next",
                setTranslate: !0,
        ...
        function re(e) {
            ...
            s.isMoved = !1,
            s.startMoving = !1,
            u = n.followFinger ? l ? t.translate : -t.translate : -s.currentTranslate,
            n.cssMode)
                return;
            ...
            for (let e = 0; e < o.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                ...
                void 0 !== o[e + t] ? (m || u >= o[e] && u < o[e + t]) && (h = e,
                f = o[e + t] - o[e]) : (m || u >= o[e]) && (h = e,
                f = o[o.length - 1] - o[o.length - 2])
            }
            let g = null
              , v = null;
            n.rewind && (t.isBeginning ? v = n.virtual && n.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1 : t.isEnd && (g = 0));
            const w = (u - o[h]) / f
              , b = h < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
            if (p > n.longSwipesMs) {
                if (!n.longSwipes)
                    return void t.slideTo(t.activeIndex);
                "next" === t.swipeDirection && (w >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? g : h + b) : t.slideTo(h)),
                "prev" === t.swipeDirection && (w > 1 - n.longSwipesRatio ? t.slideTo(h + b) : null !== v && w < 0 && Math.abs(w) > n.longSwipesRatio ? t.slideTo(v) : t.slideTo(h))
            } else {
                if (!n.shortSwipes)
                    return void t.slideTo(t.activeIndex);
                !t.navigation || r.target !== t.navigation.nextEl && r.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : h + b),
                "prev" === t.swipeDirection && t.slideTo(null !== v ? v : h)) : r.target === t.navigation.nextEl ? t.slideTo(h + b) : t.slideTo(h)
            }
        }
        function ne() {
            const e = this
        ...
        const ce = (e, t) => {
            ...
            i.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ne, !0) : e[d]("observerUpdate", ne, !0),
            r[o]("load", e.onLoad, {
                capture: !0
            })
        }
        ...
        const he = {
            ...
            translate: {
                ...
                setTranslate: function(e, t) {
                    ...
                    r.cssMode ? n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -o : -d : r.virtualTranslate || (s.isHorizontal() ? o -= s.cssOverflowAdjustment() : d -= s.cssOverflowAdjustment(),
        ...
        class ge {
            ...
            getSlideIndex(e) {
                const {slidesEl: t, params: s} = this
                  , i = D(O(t, `.${s.slideClass}, swiper-slide`)[0]);
                return D(e) - i
            }
            ...
            mount(e) {
                ...
                let r = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(i()) : O(s, i())[0];
                return !r && t.params.createElements && (r = G("div", t.params.wrapperClass),
                s.append(r),
                ...
                Object.assign(t, {
                    ...
                    mounted: !0,
                    rtl: "rtl" === s.dir.toLowerCase() || "rtl" === $(s, "direction"),
                    rtlTranslate: "horizontal" === t.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === $(s, "direction")),
                    wrongRTL: "-webkit-box" === $(r, "display")
                }),
                !0
            }
            init(e) {
            ...
            static use(e) {
                return Array.isArray(e) ? (e.forEach((e => ge.installModule(e))),
                ge) : (ge.installModule(e),
                ge)
            }
        }
        function ve(e) {
        ...
        function we(e) {
            ...
            function c(e) {
                const s = e.target.closest(ve(t.params.pagination.bulletClass));
                if (!s)
                    return;
                e.preventDefault();
                const i = D(s) * t.params.slidesPerGroup;
                if (t.params.loop) {
                    if (t.realIndex === i)
                        return;
                    t.slideToLoop(i)
            ...
            function p() {
                ...
                "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let o, p, u;
                    if (s.dynamicBullets && (a = q(r[0], t.isHorizontal() ? "width" : "height", !0),
                    c.forEach((e => {
                        e.style[t.isHorizontal() ? "width" : "height"] = a * (s.dynamicMainBullets + 4) + "px"
                    }
                    )),
                    s.dynamicMainBullets > 1 && void 0 !== n && (l += i - (n || 0),
                    ...
                    c.length > 1)
                        r.forEach((e => {
                            ...
                            s.dynamicBullets && (r >= o && r <= p && e.classList.add(...`${s.bulletActiveClass}-main`.split(" ")),
                            r === o && d(e, "prev"),
                            r === p && d(e, "next"))
                        }
                        ));
                ...
                c.forEach(( (e, n) => {
                    if ("fraction" === s.type && (e.querySelectorAll(ve(s.currentClass)).forEach((e => {
                        e.textContent = s.formatFractionCurrent(i + 1)
                    }
                    )),
                    e.querySelectorAll(ve(s.totalClass)).forEach((e => {
                    ...
                    "progressbar" === s.type) {
                        ...
                        e.querySelectorAll(ve(s.progressbarFillClass)).forEach((e => {
            ...
            function u() {
                ...
                if ("bullets" === e.type) {
                    ...
                    for (let s = 0; s < i; s += 1)
                        e.renderBullet ? n += e.renderBullet.call(t, s, e.bulletClass) : n += `<${e.bulletElement} ${t.isElement ? 'part="bullet"' : ""} class="${e.bulletClass}"></${e.bulletElement}>`
                }
                ...
                i.forEach((s => {
                    ...
                    "bullets" === e.type && t.pagination.bullets.push(...s.querySelectorAll(ve(e.bulletClass)))
                }
                )),
        ...
        ge.use([function(e) {
            ...
            s("init", ( () => {
                ...
                n.observe(t.el)) : (r.addEventListener("resize", l),
        ...
        const be = document.querySelector(".brands__slider")
          , ye = document.querySelector(".brands__wrapper")
          , Se = document.querySelectorAll(".card-brand")
          , Te = document.querySelector(".brands__slider-pagination")
          , xe = function() {
            be.classList.remove("swiper"),
            ye.classList.remove("swiper-wrapper"),
            Se.forEach((e => {
                e.classList.remove("swiper-slide")
            }
            )),
            Te.classList.add("visually-hidden")
        }
          , Ee = document.querySelector(".brands__wrapper")
          , Le = document.querySelectorAll(".card-brand")
          , Ce = []
          , Me = function() {
        ...
        function Ie() {
            be.classList.add("swiper"),
            ye.classList.add("swiper-wrapper"),
            Se.forEach((e => {
                e.classList.add("swiper-slide")
            }
            )),
            Te.classList.remove("visually-hidden"),
            Pe = new ge(".brands__slider",ke)
        }
        window.addEventListener("load", (function() {
            u.mediaMinWidthSM.matches ? xe() : (Me(),
            Ie())
        }
        )),
        u.mediaMinWidthSM.addEventListener("change", (e => {
            e.matches ? (Pe.destroy(),
            xe(),
            function() {
        ...
        const Ae = document.querySelector(".types__slider")
          , Oe = document.querySelector(".types__wrapper")
          , ze = document.querySelectorAll(".card-type")
          , Ge = document.querySelector(".types__slider-pagination")
          , $e = function() {
            Ae.classList.remove("swiper"),
            Oe.classList.remove("swiper-wrapper"),
            ze.forEach((e => {
                e.classList.remove("swiper-slide")
            }
            )),
            Ge.classList.add("visually-hidden")
        }
          , De = document.querySelector(".types__wrapper")
          , Be = document.querySelectorAll(".card-type")
          , qe = []
          , Ve = function() {
        ...
        function Re() {
            Ae.classList.add("swiper"),
            Oe.classList.add("swiper-wrapper"),
            ze.forEach((e => {
                e.classList.add("swiper-slide")
            }
            )),
            Ge.classList.remove("visually-hidden"),
            Fe = new ge(".types__slider",Ne)
        }
        window.addEventListener("load", (function() {
            u.mediaMinWidthSM.matches ? $e() : (Ve(),
            Re())
        }
        )),
        u.mediaMinWidthSM.addEventListener("change", (e => {
            e.matches ? (Fe.destroy(),
            $e(),
            function() {
        ...
        const je = document.querySelector(".prices__slider")
          , We = document.querySelector(".prices__wrapper")
          , Ye = document.querySelectorAll(".card-price")
          , Xe = document.querySelector(".prices__slider-pagination")
          , Ue = function() {
            je.classList.remove("swiper"),
            We.classList.remove("swiper-wrapper"),
            Ye.forEach((e => {
                e.classList.remove("swiper-slide")
            }
            )),
            Xe.classList.add("visually-hidden")
        }
          , Ke = document.querySelector(".prices__wrapper")
          , Qe = document.querySelectorAll(".card-price")
          , Je = []
          , Ze = function() {
            for (let e = 0; e < Qe.length; e++) {
                const t = Qe[e];
        ...
        function it() {
            je.classList.add("swiper"),
            We.classList.add("swiper-wrapper"),
            Ye.forEach((e => {
                e.classList.add("swiper-slide")
            }
            )),
            Xe.classList.remove("visually-hidden"),
            et = new ge(".prices__slider",st)
        }
        window.addEventListener("load", (function() {
            u.mediaMinWidthSM.matches ? Ue() : (Ze(),
            it())
        }
        )),
        u.mediaMinWidthSM.addEventListener("change", (e => {
            e.matches ? (et.destroy(),
            Ue(),
            function() {
        ...
        const rt = document.querySelector(".brands__slider")
          , nt = document.querySelector(".brands__show-all-button")
          , at = ["Показать все", "Скрыть"]
          , lt = rt.clientHeight;
        nt.addEventListener("click", ( () => {
            rt.clientHeight < rt.scrollHeight ? (rt.style.cssText = `\n      height: ${rt.scrollHeight}px;\n    `,
            nt.classList.add("brands__show-all-button--expanded"),
            nt.innerText = at[1]) : (rt.style.cssText = `\n      height: ${lt}px;\n    `,
            nt.classList.remove("brands__show-all-button--expanded"),
            nt.innerText = at[0])
        }
        ));
        for (const e in u)
        ...
        const ot = document.querySelector(".types__slider")
          , dt = document.querySelector(".types__show-all-button")
          , ct = ["Показать все", "Скрыть"]
          , pt = ot.clientHeight;
        dt.addEventListener("click", ( () => {
            ot.clientHeight < ot.scrollHeight ? (ot.style.cssText = `\n      height: ${ot.scrollHeight}px;\n    `,
            dt.classList.add("types__show-all-button--expanded"),
            dt.innerText = ct[1]) : (ot.style.cssText = `\n      height: ${pt}px;\n    `,
            dt.classList.remove("types__show-all-button--expanded"),
            dt.innerText = ct[0])
        }
        ));
        for (const e in u)
        ...
        const ut = document.querySelector(".types__slider")
          , mt = document.querySelector(".types__show-all-button")
          , ht = ["Показать все", "Скрыть"]
          , ft = ut.clientHeight;
        mt.addEventListener("click", ( () => {
            ut.clientHeight < ut.scrollHeight ? (ut.style.cssText = `\n      height: ${ut.scrollHeight}px;\n    `,
            mt.classList.add("types__show-all-button--expanded"),
            mt.innerText = ht[1]) : (ut.style.cssText = `\n      height: ${ft}px;\n    `,
            mt.classList.remove("types__show-all-button--expanded"),
            mt.innerText = ht[0])
        }
        ));
        for (const e in u)
